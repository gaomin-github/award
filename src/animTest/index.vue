<template>
    <div class="anim-wrapper">
        <div v-for="com in comList" :key="com" @click="changeCom(com)" class="bar">{{ com }}</div>
        <div class="item">
...
// import aCom from "./com/aCom.vue";
import bCom from "./com/bCom.vue";
import cCom from "./com/cCom.vue";
export default {
    data() {
        return {
