...
const displayStrictCode = [610103, 610104, 610113, 610116, 610124]; //碑林区，莲湖区，雁塔区，长安区，周至县
export default {
    data() {
        return {
            areaInfo: {},
    ...
    methods: {
        ...
        _initDistrict() {
            ...
            AMapUI.load(["ui/geo/DistrictExplorer", "lib/$"], function(
                ...
                districtExplorer.loadAreaNode("610100", function(
                    error,
                    areaNode
                ) {
                    if (error) {
                    ...
                    districtExplorer.renderSubFeatures(areaNode, function(
                        ...
                        console.log(feature, 231);
                        if (
                            !displayStrictCode.includes(
