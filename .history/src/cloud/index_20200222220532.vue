<template>
  <section class="cloud-wrapper">
    ...
    <ui-modal v-model="showResult">
      ...
      <section v-for="award in btnTypes" v-if="showAllResult" class="award">
        ...
        <section
          ...
          class="person"
        >
          <section class="person-item" v-if="item.awardType === award.value">
            <section class="person-item-name">{{ item.name }}</section>
            <section class="person-item-phone">{{ item.phone }}</section>
          </section>
        </section>
      </section>
      <section class="" v-for="item in curResultList">
        {{ item }}
      </section>
    </ui-modal>
  </section>
